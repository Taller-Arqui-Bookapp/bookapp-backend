...
fun Book.toEntity() = BookEntity(id, title, author, isbn, publishedYear, createdAt, coverUrl)
fun BookEntity.toDomain() = Book(id, title, author, isbn, publishedYear, createdAt, coverUrl)
